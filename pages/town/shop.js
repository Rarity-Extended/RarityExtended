...
// meal_mushroomandmeatskewer.png
	const	items = [
		{img: '/shop/meal_mushroomsoup.png', name: 'Mushroom soup', price: '4 gold, 2 mushrooms', supply: '∞', story: 'This is a basic soup. Water and mushrooms. Maybe not the best, but will give you a little boost!'},

		{img: '/shop/meal_extramushroom.png', name: 'Mushroom with mushrooms', price: '4 gold, 2 mushrooms, 1 wood', supply: '∞', story: 'Not a soup, but a meal of mushrooms with more mushroom.'},

		{img: '/shop/meal_fruitandmushroommix.png', name: 'Mushroom and fruid mix', price: '4 gold, 2 mushrooms, 2 berries', supply: '∞', story: 'Some mushrooms with berries from the forest. It\'s surprisingly good!'},

		{img: '/shop/meal_mushroomandmeatskewer.png', name: 'Mushroom meat skewer', price: '4 gold, 2 mushrooms, 1 meat', supply: '∞', story: 'You take a few mushrooms and a few piece of meat.'},

		{img: '/shop/meal_gourmetfruitandmushroom.png', name: 'Gourmet meal with Mushroom', price: '4 gold, 2 mushrooms, 2 berries, 1 meat', supply: '∞', story: 'The perfect meal for another adventure ! Some mushroom, some berries and a piece of meat.'},
	];
