...
function	AppWrapper(props) {
	...
	return (
		<>
			...
			<main id={'app'} className={'p-4 relative font-title uppercase text-black dark:text-white bg-white dark:bg-dark-600'} style={{width: 'calc(100% - 1.5rem)', minHeight: '100vh'}}>
