		...
		if (boarEscaped) {
			return (
				<div className={'grid grid-cols-1 gap-4 mt-4 border-t-2 border-black dark:border-dark-300 pt-4'}>
					<div onClick={() => router.push('/adventures/the-boars')} className={'rounded-md font-story p-4 flex flex-center text-base bg-600 bg-opacity-40 hover:bg-opacity-100 dark:bg-opacity-40 dark:hover:bg-opacity-100 transition-visibility cursor-pointer normal-case'}>
