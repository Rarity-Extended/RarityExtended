	...
	return (
		<div className={'flex flex-col w-full'}>
			<div className={'pb-10'}>
				...
				<div />
				<i className={'text-sx md:text-xs text-black dark:text-white text-opacity-60 leading-6'}>
					{'He speaks of a Dark Forest to the North about a week\'s travel, there and back, with danger but treasure. He isn\'t willing to guide you there, because he was hurt too much but he will tell you where to go. He doesn\'t want anything in return for helping you.'}
				</i>
