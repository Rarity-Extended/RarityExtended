...
function	Button({children, className, onClick, backgroundColor = 'bg-white dark:bg-dark-600 hover:bg-gray-primary dark:hover:bg-dark-400'}) {
	...
	return (
		<div className={`relative ${className} py-3 px-14 text-regular`} onClick={onClick}>
			...
			<div className={`${borderStyle} h-1 w-1 bottom-1 left-0`} />
			<div className={`${borderStyle} h-1 w-1 bottom-1 right-0`} />
			<div className={`${borderStyle} h-1 bottom-0 left-1 right-1`} />

			<div className={`${borderStyle} h-1 w-1 top-2 right-2`} />
			<div className={`${borderStyle} h-1 w-1 top-2 left-2`} />
			<div className={`${borderStyle} h-1 w-1 bottom-2 right-2`} />
			<div className={`${borderStyle} h-1 w-1 bottom-2 left-2`} />
